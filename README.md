Hackathon Starter para MgCoders
=======================

Leer el README_ORIGINAL.md
Esto levanta un MEAN con todo, hay que quedarse con lo que sirva y borrar el resto.

Desarrollamos acá
``docker-compose -f docker-compose-dev.yml up``

Empaquetamos así
``docker build -t mgcoders/hackathon-starter:0.1 .``

Opcionalmente push al repo de contenedores
``docker push mgcoders/hackathon-starter:0.1``
